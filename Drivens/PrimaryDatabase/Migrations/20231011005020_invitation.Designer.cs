...
namespace Database.Migrations
{
    ...
    [Migration("20231011005020_invitation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Application.Domain.Entities.Invitation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Application.Domain.Entities.OrgGlobalInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Application.Domain.Entities.OrgGlobalInvitation", b =>
                {
                    b.HasOne("Application.Domain.Entities.Organization", "Organization")
                        .WithMany("OrgGlobalInvitationList")
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Application.Domain.Entities.Organization", b =>
                {
                    ...
                    b.Navigation("InvitationList");

                    b.Navigation("MemberList");

                    b.Navigation("OrgGlobalInvitationList");
                });
